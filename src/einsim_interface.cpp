 ...
 *
 * @brief [Adapted from the original BEER project] Utility routines that
 * interface with the EINSim simulator and aren't part of the core HARP
 * artifacts
 *
 ...
 */
std::string einsim_generate_ecc_code(const std::string &einsim_binary, const uint64_t desired_k, const uint64_t desired_p)
{
